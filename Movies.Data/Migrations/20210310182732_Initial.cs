        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(maxLength: 50, nullable: true),
                    ShortDescription = table.Column<string>(maxLength: 500, nullable: true),
                    DateBirth = table.Column<DateTime>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieProductionCompany = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<int>(nullable: false),
                    MovieId = table.Column<int>(nullable: false),
                    FilmDirectorId = table.Column<int>(nullable: false),
                    ProductionCompanyId = table.Column<int>(nullable: false),
                    WritterId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<int>(nullable: false),
                    Actor = table.Column<string>(maxLength: 50, nullable: true),
                    ActorId = table.Column<int>(nullable: false),
                    FilmDirector = table.Column<string>(maxLength: 100, nullable: true),
                    FilmDirectorId = table.Column<int>(nullable: false),
                    Writter = table.Column<string>(maxLength: 100, nullable: true),
                    WritterId = table.Column<int>(nullable: false),
                    ProductionCompany = table.Column<string>(maxLength: 100, nullable: true),
                    ProductionCompanyId = table.Column<int>(nullable: false),
                    ...
                    PlotSummary = table.Column<string>(maxLength: 500, nullable: true),
                    Language = table.Column<string>(maxLength: 50, nullable: true),
                    CountryOfOrigin = table.Column<string>(maxLength: 50, nullable: true),
                    Subtitles = table.Column<string>(maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movies_Writters_WritterId",
